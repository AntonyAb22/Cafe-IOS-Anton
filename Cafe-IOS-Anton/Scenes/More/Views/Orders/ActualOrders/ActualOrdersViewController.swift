//
//  ActualOrdersViewController.swift
//  Cafe-iOS-Anton
//
...
class ActualOrdersViewController: TableView  {

    var presenter: ActualOrdersPresenter?
    var router: ActualOrdersRouter?
...
extension ActualOrdersViewController: UITableViewDelegate, UITableViewDataSource {
    
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        presenter?.items.count ?? 10 // 10 исправить на 0
    }
